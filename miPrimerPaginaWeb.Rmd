...
En esta sección aprendremos cómo modificar partes como columnas de un objeto data.frame (sin que sea exclusivo de este tipo de objeto) con operaciones sencillas. Como ejemplo, cambiaremos la columna Fecha del objeto Datos para que deje de ser una secuencia de números de fecha de Excel y se convierta en un objeto tipo Date con la función as.Date():
